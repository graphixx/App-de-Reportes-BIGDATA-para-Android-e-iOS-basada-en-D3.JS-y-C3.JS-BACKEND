...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Admin Demo de la App de Reportes">
    <meta name="author" content="www.sistemasycontroles.com">
    <meta property="og:image" content="https://www.sistemasycontroles.com/app_reportes_demo/admin/sistemasycontroles.com.png">
    <!-- Favicon -->
    <link rel="shortcut icon" href="favicon.ico" />

    <title>Admin Demo de la App de Reportes</title>
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
              <li class="active"><a href="index.php">Editor CSV</a></li>
...
?>
                ...
                <div class="text-right">
                    <a href="#" id="addrow" class="btn btn-default"><i class="fa fa-plus"></i> Agregar filas</a>
                </div>
                <hr>
                <div>
                    <a href="#" id="cancel" class="btn btn-default"><i class="fa fa-undo"></i> Deshacer</a>
                    <a href="#" id="save" class="btn btn-primary"><i class="fa fa-save"></i> Guardar cambios</a>
                </div>
                </form>
